...
{{-- NIM --}}
<div class="form-group mb-3">
    <label class="form-label" for="nim">NIM</label> <br>
    <input id="nim" type="text" class="form-control @error('nim') is-invalid @enderror" name="nim" value="{{ Auth::user()->students->nim  }}" required autocomplete="nim" placeholder="NIM" autofocus>
...
<div class="form-group mb-3">
    ...
    <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ Auth::user()->students->name  }}" required autocomplete="name" placeholder="Full Name" autofocus>
...
<div class="form-group mb-3">
    ...
    <input id="birthplace" type="text" class="form-control @error('birthplace') is-invalid @enderror" name="birthplace" value="{{ Auth::user()->students->birthplace  }}" required autocomplete="birthplace" placeholder="Birth Place" autofocus>
...
<div class="form-group mb-3">
    ...
    <input id="phone" type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{ Auth::user()->students->phone }}" required autocomplete="phone" placeholder="Phone" autofocus>
...
<div class="form-group mb-3">
    ...
    value="{{ Auth::user()->students->address }}"required autocomplete="address">
