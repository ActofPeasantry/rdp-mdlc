...
<div class="form-group mb-3">
    ...
    <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ Auth::user()->admins->name  }}" required autocomplete="name" placeholder="Full Name" autofocus>
...
<div class="form-group mb-3">
    ...
    <input id="birthplace" type="text" class="form-control @error('birthplace') is-invalid @enderror" name="birthplace" value="{{ Auth::user()->admins->birthplace  }}" required autocomplete="birthplace" placeholder="Birth Place" autofocus>
...
<div class="form-group mb-3">
    ...
    <input id="phone" type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{ Auth::user()->admins->phone }}" required autocomplete="phone" placeholder="Phone" autofocus>
...
<div class="form-group mb-3">
    ...
    value="{{ Auth::user()->admins->address }}"required autocomplete="address">
