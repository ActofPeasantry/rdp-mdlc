...
<div class="form-group mb-3">
    ...
    value="{{ old('name') }} @isset($user) {{$admin->name}}  @endisset"
...
<div class="form-group mb-3">
    ...
    value="{{ old('username') }} @isset($user) {{$admin->users->username}}  @endisset"
...
<div class="form-group mb-3">
    ...
    value="{{ old('email') }} @isset($user) {{$admin->users->email}}  @endisset"
...
<div class="form-group mb-3">
    ...
    value="{{ old('name') }} @isset($user) {{$admin->birthplace}}  @endisset"
